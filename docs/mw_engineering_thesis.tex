...
The next section presents how rules of CA simulation are encapsulated and applied.

\subsection{Simulating CA rules} 
\subsubsection{Data structures}
As described in \cref{rozdzial.teoria}, basic CA rules check the values of adjacent cells to a selected cell and determine its subsequent state.
\subsubsection{Operations}
