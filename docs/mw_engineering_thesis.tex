...
A degree of control achieved by introducing graphical user interface to the process has provided an opportunity to visualize how each tile evolves and ability to select tile with desired shapes for the map being constructed, but .
