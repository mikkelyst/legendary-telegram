...
Making a model of the physical (or fictional) world with maps requires choice of the data types describing locations represented on the map. List of data types visualized with maps have been growing with the evolution of cartography and as new technologies have been introduced to the map making crafts. Some examples of data possible to represent on maps are:
...
\begin{itemize}
	...
	\item climate maps - average temperature, humidity, precipitation
...
\td{ add image examples of 2d maps, 3d maps, pure data maps}
...
Another game, originating from ancient China, defines a similar game world. 
\td{expand on Go}
...
\end{figure}
 ...
 \td{ one more board game, modern}
 
 
Modern times allowed for ... 
...
\begin{figure}[h]
	...
	\caption{A game map using ASCII art - source?}
