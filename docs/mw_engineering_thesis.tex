...
\begin{itemize}
	\item drawing the tiles must be done in real time, whenever their state changes
	\item 
	\item \td{+}
\end{itemize}
...
\subsection{Basic cellular automata simulations}

 As stated in Nature of Code \autocite{shiffman2012nature}, a 2-dimensional CA would need the following key elements to be simulated:
