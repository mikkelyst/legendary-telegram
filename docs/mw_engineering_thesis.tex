...
The model presented above is implemented by data and operations contained in the $Board$ class. 
...
\td{TileGenerator class}
\td{collection of Boards is a history of steps}
\td{singe board after X steps becomes a useful tile}

\subsubsection{Operations}
\td{tile data written into map}
