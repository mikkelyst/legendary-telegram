...
Since we have selected an approach to map generation based on cellular automata in chapter \ref{rozdzial.teoria}, we have to include simulation of CA states.     
...
\begin{enumerate}
	\item The program must have a user interface that allows to change generation parameters easily
	\item Generation parameters must be logically grouped and ordered to avoid user confusion
