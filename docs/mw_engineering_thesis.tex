...
%%%%%%%%%%%%%%%
\section{History of maps} 

Before we start planning a solution to the problem of map generation, we must first define the context properly. Historically, 
...
%%%%%%%%%%%%%%%
\section{Maps in computer games} 

\td{examples from games: Diablo, Ultima Regum, MMORPG, other-}
...
\end{verbatim*}
\td{remove verbatim to include listings. warning: this will generate about 30 a4paper pages}
