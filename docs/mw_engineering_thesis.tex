...
\td{describe ui classes} 

\Cref{fig:uiwindows} shows how user interface classes are organized.
\begin{figure}[h]
	\centering
...
Such emergent condition can be thought of as a $balanced state$ of a tile, since rules seemingly cannot further modify the tile after a sufficient number of transformations. It is however possible that map designers may decide to use a tile before it reaches such state. Furthermore, exploring different sets of rules for tile generation may reveal better rules for creation of useful tiles.
...
\begin{figure}[t!]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[height=5cm]{images/step1}
		\caption{Step 1 - random noise} 
	\end{subfigure} \hspace{1em}
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[height=4cm]{images/step2}
		\caption{Step 2 - generated tile} 
	\end{subfigure} \hspace{1em}

	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[height=4cm]{images/step3}
		\caption{Step 3 - tiles in a grid} 
	\end{subfigure} \hspace{1em}
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[height=4cm]{images/step4}
