...
\td{implementing editing operations on the tile before placing it in the map. }
\td{procedural generation of game maps which resemble cave structures}
\td{approach will be selected 
	and examined with 
	implementing a working map generator.
}
...
\td{Add only strict information about what you program/thesis should do/improve. Based it on implementation and techniques described in articles that you have cited. Don't add what CAN be done, but rephrase it to what HAVE been done.}
