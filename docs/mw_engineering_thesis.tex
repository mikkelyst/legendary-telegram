...
\td{CA examples: Ultima Ratio Regum, Dwarf Fortress (2006), Minecraft }
...
One of possible approaches to map generation which can create irregular shapes is the work of L. Johnson, G. Yannakakis and J. Togelius from IT University of Copenhagen \autocite{johnson2010cellular}. Authors describe rules of a cellular automaton which are able to transform a tile filled initially with random distribution of cells into a tile which has interesting properties for a map designer.
