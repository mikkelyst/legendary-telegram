...
However, some of the more complex game rules and ideas are better implemented using computer simulation, since most of the mundane tasks which do not contribute to gameplay can be automated. Activities like random number generation, board arrangement, checking player moves against game rules - are good candidates for automation.
